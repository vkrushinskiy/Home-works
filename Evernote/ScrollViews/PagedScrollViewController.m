...
- (void)viewDidLoad {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:@"EVERNOTE" delegate:self  cancelButtonTitle:@"Touch" otherButtonTitles:nil];
    [alert show];
    
    
    // Set up the image we want to scroll & zoom and add it to the scroll view
    self.pageImages = [NSArray arrayWithObjects:
                       [UIImage imageNamed:@"man.jpeg"],
                       [UIImage imageNamed:@"man2.jpeg"],
                       [UIImage imageNamed:@"man.jpeg"],
                       [UIImage imageNamed:@"man2.jpeg"],
                       [UIImage imageNamed:@"man.jpeg"],
                       nil];
